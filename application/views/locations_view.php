        ...
        <div class="row">
            <div class="lower__txt col s3 -custom-col">
                <ul class="header__txt--head">
                    <li><a href="#scrollDown">Roast8ry: Roaster factory</a></li>
                    <li><a href="#scrollDown">Roast8ry: Flagship store</a></li>
                    <li><a href="#scrollDown">Roast8ry: LAB</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="locations__wrap hide-on-small-only container  id="target_down"">
    <div class="row session__locations">
        ...
        <div class="col m12 locations__content__new center">
            <ul>
                <li>
