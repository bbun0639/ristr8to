<nav class="nav__top" role="navigation">
    <div class="nav-wrapper">
        <div  class="hide-on-med-and-up">
            <a href="<?php echo site_url(); ?>" class="brand-logo logo-top"><img src="<?php echo base_url('assets/images/logo2_ristr8to_white.png'); ?>" style="padding-right: 28px;"></a>
        </div>
        ...
        <ul class="hide-on-med-and-down nav__center right">
            ...
            <li>
                <div class="menu__icon">
                    <a href="#" data-activates="slide-out" id="btn-cart" class="ico_cart"></a>
                    <a href="https://www.facebook.com/ristr8to/" target="_blank" class="ico_fb"></a>
                    <a href="https://www.instagram.com/ristr8to/" target="_blank" class="ico_ig"></a>
...
<!--        <ul id="nav-mobile" class="side-nav" style="background-color: black; opacity: 0.80; z-index:99999 !important;">
            <li>
